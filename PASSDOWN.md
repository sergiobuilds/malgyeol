...
verified_at: 2026-09-18T06:02:43.328419+00:00
canonical_ref: refs/heads/master
verified_commit: fca058b2cf5fd296ed91324a9275a8f5ba6db880
---

## Next

- 회신 중간 끊김 수정: SDK playback mark는 5초 timeout 뒤에도 종료하므로 생성 PCM 길이 기반 잔여 재생시간을 먼저 기다린다. prewarm 버퍼는 실제 attach 시각부터 재계산, interruption은 예약 종료 취소. Python94 통과(12초 음성/20초 ringing 뒤9초버퍼/중단/SDK mark). 실전화 청취·전체60초 확인은 남음. 시연 caller는 사용자 지정 새 번호1개로 private 설정, 이전2개 제거.
