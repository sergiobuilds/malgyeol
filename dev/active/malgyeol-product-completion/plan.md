...
- 완료: A→서비스→B→A, 부분 해결·조건 변경·부재 수동 재시도, 한 통화·멱등성.
- 검증: 역할 첫 인사/양방향 오디오/답변에 따른 사건 변화. health를 실통화 증거로 세지 않음.
