...
const cases = [{
  ...
  paymentReference: 'synthetic_reference_1', authorizedAmountKrw: 380_000, providerOrderId: 'DEMO-ORDER-1',
  createdAt: 1000, updatedAt: 2000
}];

test('legacy workbook has four institution sheets and keeps payment evidence explicit', () => {
  ...
  assert.equal(evidence[0]?.['승인 금액(원)'], 380_000);
